      ...
      <div class="container mx-auto px-6 py-4 flex flex-wrap items-center justify-between gap-6">
        ...
        <div class="flex items-center gap-10">
          <a href="/" class="flex items-center gap-4 group">
            <div class="relative w-14 h-14 flex items-center justify-center">
                ...
                <img src="/assets/images/logo.png" alt="Logo" class="w-10 h-10 object-contain relative transform group-hover:scale-110 group-hover:-rotate-6 transition-all duration-500 drop-shadow-[0_0_20px_rgba(245,158,11,0.5)]">
            </div>
        ...
        <nav class="flex items-center gap-4">
          <div class="flex items-center gap-2 bg-white/5 p-1.5 rounded-[1.5rem] border border-white/5">
            <a href="/" class="nav-btn group" title="${t('home')}">
              <i class="fas fa-home"></i>
              <span class="nav-tooltip">${t('home')}</span>
            </a>
            <a href="/pages/finder/" class="nav-btn group" title="${t('advanced_search')}">
              <i class="fas fa-filter"></i>
              <span class="nav-tooltip">${t('advanced_search')}</span>
            </a>
            <a href="/pages/watchlist/" class="nav-btn group" title="${t('watchlist')}">
              <i class="fas fa-clapperboard"></i>
              <span class="nav-tooltip">${t('watchlist')}</span>
            </a>
            <button id="open-settings-modal" class="nav-btn group" title="${t('settings')}">
              <i class="fas fa-sliders-h"></i>
              <span class="nav-tooltip">${t('settings')}</span>
            </button>
          </div>
        ...
        <div class="p-8">
          <div class="flex justify-between items-center mb-10">
            <div class="flex items-center gap-4">
              ...
              <div>
                <h2 class="text-2xl font-black text-white tracking-tighter">${t('user_settings')}</h2>
                <p class="text-gray-500 text-xs font-bold mt-1">FreeMovieIR Premium Experience</p>
              </div>
            </div>
          ...
          <div class="space-y-8">
            <div class="space-y-4">
              <label class="block text-sm font-black text-gray-400">${t('language')}</label>
              <select id="modal-lang-select" class="w-full bg-black/30 border border-white/10 text-white px-5 py-3 rounded-2xl focus:border-amber-500/50 outline-none transition-all text-sm appearance-none cursor-pointer">
            ...
            <div class="space-y-4">
              <label class="block text-sm font-black text-gray-400">${t('tmdb_token')}</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 text-right">
                <div class="space-y-8 col-span-1 lg:col-span-2">
                    <a href="/" class="flex items-center gap-4 group">
                        ...
                        <span class="text-3xl font-black text-white tracking-tighter">${t('site_title')}</span>
                    </a>
                    <p class="text-gray-400 text-base leading-9 max-w-xl font-medium">
                        ${t('footer_desc')}
                    </p>
                    <div class="flex items-center gap-4">
                        <a href="https://twitter.com/freemovie_ir" target="_blank" class="footer-social-btn hover:bg-[#1DA1F2]"><i class="fab fa-twitter"></i></a>
                        <a href="https://instagram.com/freemovie_ir" target="_blank" class="footer-social-btn hover:bg-gradient-to-tr hover:from-[#f9ce34] hover:via-[#ee2a7b] hover:to-[#6228d7]"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
                ...
                <div class="space-y-8">
                    ...
                    <nav class="flex flex-col gap-5">
                        <a href="/pages/search/" class="footer-link">${t('advanced_search')}</a>
                        <a href="/pages/watchlist/" class="footer-link">${t('watchlist')}</a>
                    </nav>
                </div>
                ...
                <div class="space-y-8">
                    ...
                    <nav class="flex flex-col gap-5">
                        <a href="#" onclick="window.i18n.setLanguage('fa')" class="footer-link">فارسی</a>
                        <a href="#" onclick="window.i18n.setLanguage('en')" class="footer-link">English</a>
                    </nav>
                </div>
            </div>

            <div class="mt-24 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                <span class="text-gray-500 text-sm font-bold">${t('copyright')}</span>
                <div class="text-gray-600 text-[10px] font-bold uppercase tracking-widest bg-white/5 px-4 py-2 rounded-full border border-white/5">
                    ${t('design_credit')}
                </div>
            </div>
        </div>
