    ...
    <header class="sticky top-0 z-50 backdrop-blur-md bg-base-900/80 border-b border-gray-800 shadow-lg transition-all duration-300">
      <div class="container mx-auto flex flex-row justify-between items-center px-4 py-3">
        <nav class="flex items-center space-x-2 md:space-x-4">
          ...
          <a href="/pages/finder/index.html" class="group flex items-center justify-center w-10 h-10 rounded-full hover:bg-gray-800 transition-all duration-300 relative" aria-label="جستجوی هوشمند">
          ...
          <a href="/pages/watchlist/" class="group flex items-center justify-center w-10 h-10 rounded-full hover:bg-gray-800 transition-all duration-300" aria-label="واچ‌لیست">
            <i class="fas fa-bookmark text-gray-400 group-hover:text-accent group-hover:scale-110 transition-transform duration-300"></i>
          </a>
          <a href="/pages/search/" class="group flex items-center justify-center w-10 h-10 rounded-full hover:bg-gray-800 transition-all duration-300" aria-label="جستجو">
            <i class="fas fa-search text-gray-400 group-hover:text-accent group-hover:scale-110 transition-transform duration-300"></i>
          </a>
          <a href="/pages/settings/index.html" class="group flex items-center justify-center w-10 h-10 rounded-full hover:bg-gray-800 transition-all duration-300" aria-label="تنظیمات">
        ...
        <div class="flex items-center">
          <a href="/" class="flex items-center gap-2 group">
            <img src="/assets/images/logo.png" alt="لوگوی فیری مووی" class="h-10 transform group-hover:scale-105 transition-transform duration-300 drop-shadow-[0_0_8px_rgba(255,193,7,0.5)]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-right">
          ...
          <div class="flex flex-col items-center md:items-start">
             <a href="/" class="flex items-center gap-2 mb-4 group">
                <img src="/assets/images/logo.png" alt="لوگوی فیری مووی" class="h-10 opacity-80 group-hover:opacity-100 transition-opacity">
