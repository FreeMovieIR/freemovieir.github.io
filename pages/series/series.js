...
async function fetchRelatedSeries(currentSeriesId, tmdbApiKey, lang, switcher) {
    ...
    try {
        ...
        relatedSeries.forEach(serie => {
            ...
            relatedHtml += `
                <a href="/pages/series/index.html?id=${serie.id}" class="group block bg-base-800/80 rounded-xl overflow-hidden hover:scale-105 hover:shadow-[0_10px_30px_rgba(255,193,7,0.15)] transform transition-all duration-300 border border-gray-700/30 relative">
